...
## Code
The [`ndn/app`](ndn/app/), [`icn-oscore/app`](icn-oscore/app), and [`icn-detoscore/app`](icn-detoscore/app) folders contain the applications that we used to perform our experiments.
